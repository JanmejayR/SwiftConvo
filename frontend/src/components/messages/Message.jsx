  ...
  return (
    <div className="chat chat-end">
        <div className="chat-image avatar">
          ...
          <div className={`chat-bubble text-white bg-blue-500`}>Hi! What is up? fuck off bitch</div>
			<div className='chat-footer opacity-50 text-xs flex gap-1 items-center'>2:29</div>
